...
function Cli(argv) {
  ...
  function getProgram () {
    ...
    program
      ...
      .option('--shortStackTraces', 'Show only top stack frame for errors')
      .option('--findStepDef', 'Find a step definition for a feature file line\n  Example:\n    --findStepDef specification.feature:24\nOutputs file with location, like\n    ~/support/mydefs.js:86\n')
      .option('--brkOnSupportedCodeLoaded', 'Trigger a debugger break once support code is loaded')
      .option('--unusedSteps', 'Show unused step definitions');
